			...
			<div className='tweet'>
	            ...
	            {showMetrics && <div className='metrics'>
                     <HStack isInline>
                                ...
                                <Box className='seclikes' fontsize={font_size_small}> 
                                <svg style={{color: '#E81C4F'}} viewBox="0 0 54 72" width="16" fill="currentColor" focusable="false">
                                ...
                                <Text className='bold' fontsize={font_size_small}>{modLikes}</Text>
                      
                                 <Box className='sec' fontsize={font_size_small}> 
                                 <svg style={{color: '#19CF86'}} viewBox="0 0 75 72" width="16" fill="currentColor" focusable="false">
                                ...
                                <Text className='bold' fontsize={font_size_small}>{modRetweets}</Text> 
                     </HStack>

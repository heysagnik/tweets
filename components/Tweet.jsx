	            ...
	            {showMetrics && <div className='metrics'>
                	<Text fontSize={font_size_small}>
                		<span className='bold'>{modLikes}</span> 
                                <span className='sec likes'> 
                                <svg style={{color: '#E81C4F'}} viewBox="0 0 24 24" width="16" fill="currentColor" focusable="false">
                                ...
                                </span>  <span className='bold'>{modRetweets}</span> <span className='sec'> Retweets</span>
                	</Text>
	            </div>}
	        </div>
	  	</Box>
